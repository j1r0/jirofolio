...
const hero = () => {
  return (
    <section className = "relative w-screen h-dvh flex">
...
{/* Typer */}
  ...
  <button className="dark:border-white border-black-100 dark:text-white text-black-100 text-sm mobile:text-base tablet:text-xl uppercase font-bold py-2 px-4 rounded-lg border-2">Check out my story</button>
